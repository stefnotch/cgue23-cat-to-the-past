...
pub fn create_debug_callback(instance: Arc<Instance>) {
...
pub fn find_physical_device(instance: Arc<Instance>, surface: Arc<Surface>,
...
pub fn create_logical_device(physical_device: Arc<PhysicalDevice>,
